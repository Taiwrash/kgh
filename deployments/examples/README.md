...
All these examples work seamlessly with KGH's GitOps workflow:

1. **Copy the example** to your Git repository
2. **Customize** as needed (change names, namespaces, resources)
3. **Commit and push** to your repository
4. **Watch KGH** automatically apply the changes to your cluster
...
# KGH automatically applies the changes! 🎉
```
